...
<ExportCodeRefactoringProvider(LanguageNames.VisualBasic, Name:=NameOf(VB_Code_Refactoring_dotnet_StandardCodeRefactoringProvider)), [Shared]>
Friend Class VB_Code_Refactoring_dotnet_StandardCodeRefactoringProvider
