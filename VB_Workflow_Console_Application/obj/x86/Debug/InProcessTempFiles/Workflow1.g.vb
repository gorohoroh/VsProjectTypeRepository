...
End Sub
    ...
    <System.CodeDom.Compiler.GeneratedCodeAttribute("XamlBuildTask", "15.0.0.0")>  _
    Public Sub New()
        MyBase.New
    ...
    Public Sub InitializeComponent()
        ...
        Dim initializeXaml As System.IO.Stream = GetType(Workflow1).Assembly.GetManifestResourceStream(resourceName)
        ...
        Try 
            ...
            writerSettings.AccessLevel = System.Xaml.Permissions.XamlAccessLevel.PrivateAccessTo(GetType(Workflow1))
    ...
    Private Function FindResource() As String
        Dim resources() As String = GetType(Workflow1).Assembly.GetManifestResourceNames
        Dim i As Integer = 0
        Do While (i < resources.Length)
            Dim resource As String = resources(i)
            If (resource.Contains(".Workflow1.g.xaml") OrElse resource.Equals("Workflow1.g.xaml")) Then
                Return resource
            End If
            i = (i + 1)
        Loop
