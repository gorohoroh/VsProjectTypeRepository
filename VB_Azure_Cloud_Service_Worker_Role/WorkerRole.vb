...
Public Class WorkerRole
    ...
    Public Overrides Sub Run()
        Trace.TraceInformation("VB_Azure_Cloud_Service_Worker_Role is running")
    ...
    Public Overrides Function OnStart() As Boolean
        ...
        Trace.TraceInformation("VB_Azure_Cloud_Service_Worker_Role has been started")
    ...
    Public Overrides Sub OnStop()
        ...
        Trace.TraceInformation("VB_Azure_Cloud_Service_Worker_Role is stopping")
        ...
        Trace.TraceInformation("VB_Azure_Cloud_Service_Worker_Role has stopped")
