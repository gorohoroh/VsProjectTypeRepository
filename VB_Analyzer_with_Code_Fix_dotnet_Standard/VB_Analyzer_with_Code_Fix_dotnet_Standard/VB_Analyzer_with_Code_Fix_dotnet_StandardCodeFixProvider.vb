...
<ExportCodeFixProvider(LanguageNames.VisualBasic, Name:=NameOf(VB_Analyzer_with_Code_Fix_dotnet_StandardCodeFixProvider)), [Shared]>
Public Class VB_Analyzer_with_Code_Fix_dotnet_StandardCodeFixProvider
    ...
    Public NotOverridable Overrides ReadOnly Property FixableDiagnosticIds As ImmutableArray(Of String)
        Get
            Return ImmutableArray.Create(VB_Analyzer_with_Code_Fix_dotnet_StandardAnalyzer.DiagnosticId)
        End Get
    End Property
