...
namespace Code_Refactoring_dotnet_Standard
{
    [ExportCodeRefactoringProvider(LanguageNames.CSharp, Name = nameof(Code_Refactoring_dotnet_StandardCodeRefactoringProvider)), Shared]
    internal class Code_Refactoring_dotnet_StandardCodeRefactoringProvider : CodeRefactoringProvider
    {
